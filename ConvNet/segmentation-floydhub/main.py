...
def configure():
	...
	flags.DEFINE_string('pretrain_file', '/data/reference model/deeplab_resnet_init.ckpt', 'pre-trained model filename corresponding to encoder_name')
	...
	flags.DEFINE_integer('valid_num_steps', 1110, '= number of validation samples')
	...
	flags.DEFINE_integer('test_num_steps', 1110, '= number of testing/validation samples')
	...
	# data
	flags.DEFINE_string('data_dir', '/data/VOCdevkit/VOC2012', 'data directory')
	...
	# log
	flags.DEFINE_string('modeldir', '/output/model', 'model directory')
	flags.DEFINE_string('logfile', 'log.txt', 'training log filename')
	flags.DEFINE_string('logdir', '/output/log', 'training log directory')
